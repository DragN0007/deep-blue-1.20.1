...
public class KrillSwarm extends AbstractSchoolingFish implements GeoEntity {
    ...
    public KrillSwarm(EntityType<? extends AbstractSchoolingFish> entity, Level level) {
        super(entity, level);
        this.noCulling = true;
    }
    ...
    public SpawnGroupData finalizeSpawn(ServerLevelAccessor levelAccessor, DifficultyInstance difficultyInstance, MobSpawnType mobSpawnType, @Nullable SpawnGroupData spawnGroupData, @Nullable CompoundTag compoundTag) {
        if(compoundTag != null && compoundTag.contains("Variant")) {
            ...
            setTexture(BettasMain.RANDOM.nextInt(KrillSwarmVariant.values().length));
        }
